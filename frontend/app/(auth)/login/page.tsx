...
const LoginPage = () => {
    ...
    const handleSubmit = async (e: React.SyntheticEvent) => {
        ...
        // Call our Next.js API route — not the Railway API directly.
        // The route handles setting the httpOnly cookie server-side.
        ...
        >
            <div className="w-full max-w-sm flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-white/40 text-sm">Welcome back to TCG</p>
                </div>
